...
class SiswaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            Log::error('Error saving siswa data: ' . $e->getMessage());
    ...
    public function show($id)
    {
        try {
            ...
            Log::error('Error fetching siswa with ID ' . $id . ': ' . $e->getMessage());
    ...
    public function update(Request $request, $id)
    {
        try {
            ...
            Log::error('Error updating siswa with ID ' . $id . ': ' . $e->getMessage());
    ...
    public function destroy($id)
    {
        try {
            ...
            Log::error('Error deleting siswa with ID ' . $id . ': ' . $e->getMessage());
